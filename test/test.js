...
describe('infinite-scroll', function() {
  var testParent, testParents, _i, _len, _results;
  ...
  this.parentElementCustomized = angular.element("<div class=\"container\"></div>");
  this.parentElementBody = angular.element("<body></body>");
  testParents = [this.parentElementCustomized, this.parentElementBody];
  _results = [];
  for (_i = 0, _len = testParents.length; _i < _len; _i++) {
    testParent = testParents[_i];
    beforeEach(function() {
      this.element.wrap(testParent);
    ...
    _results.push(describe('#setActive', function() {
